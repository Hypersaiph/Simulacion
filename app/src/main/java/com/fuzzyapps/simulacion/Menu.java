...
public class Menu extends AppCompatActivity {
    private Button option_1, option_2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_menu);
        option_1 = (Button)findViewById(R.id.option_1);
        option_2 = (Button)findViewById(R.id.option_2);
        option_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Menu.this, RandomGeneration.class);
